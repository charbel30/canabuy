...
const Colors = {
  light: {
    ...
    canadian: {
      primary: 'rgb(255, 0, 0)', // Canadian red
      onPrimary: 'rgb(255, 255, 255)',
      primaryContainer: 'rgb(255, 219, 219)',
      onPrimaryContainer: 'rgb(65, 0, 0)',
      secondary: 'rgb(117, 86, 86)',
      onSecondary: 'rgb(255, 255, 255)',
      secondaryContainer: 'rgb(255, 218, 218)',
      onSecondaryContainer: 'rgb(43, 21, 21)',
      tertiary: 'rgb(122, 87, 91)',
      onTertiary: 'rgb(255, 255, 255)',
      tertiaryContainer: 'rgb(255, 217, 223)',
      onTertiaryContainer: 'rgb(44, 21, 25)',
  ...
  dark: {
    ...
    canadian: {
      primary: 'rgb(255, 179, 179)', // Light Canadian red for dark theme
      onPrimary: 'rgb(102, 0, 0)',
      primaryContainer: 'rgb(147, 0, 0)',
      onPrimaryContainer: 'rgb(255, 218, 218)',
      secondary: 'rgb(231, 189, 189)',
      onSecondary: 'rgb(68, 42, 42)',
      secondaryContainer: 'rgb(93, 64, 64)',
      onSecondaryContainer: 'rgb(255, 218, 218)',
      tertiary: 'rgb(236, 190, 195)',
      onTertiary: 'rgb(70, 42, 47)',
      tertiaryContainer: 'rgb(96, 64, 69)',
      ...
      onBackground: 'rgb(237, 224, 224)',
      surface: 'rgb(32, 26, 27)',
      onSurface: 'rgb(237, 224, 224)',
      surfaceVariant: 'rgb(83, 67, 70)',
      onSurfaceVariant: 'rgb(216, 194, 196)',
      outline: 'rgb(160, 141, 143)',
      outlineVariant: 'rgb(83, 67, 70)',
      shadow: 'rgb(0, 0, 0)',
      scrim: 'rgb(0, 0, 0)',
      inverseSurface: 'rgb(237, 224, 224)',
      inverseOnSurface: 'rgb(54, 47, 48)',
      inversePrimary: 'rgb(255, 0, 0)',
      elevation: {
        level0: 'transparent',
        level1: 'rgb(43, 34, 35)',
        level2: 'rgb(50, 38, 40)',
      ...
      surfaceDisabled: 'rgba(237, 224, 224, 0.12)',
      onSurfaceDisabled: 'rgba(237, 224, 224, 0.38)',
      backdrop: 'rgba(58, 45, 47, 0.4)',
    },
    orange: {
